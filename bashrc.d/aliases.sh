...
alias aws_claude='export AWS_PROFILE=claude-code && aws sso login'
...
alias aws_bedrock_dev='export AWS_PROFILE=bedrock-dev && aws sso login'
alias aws_bedrock_prod='export AWS_PROFILE=bedrock-prod && aws sso login'
alias aws_csva='export AWS_PROFILE=customersupport-va'
alias aws_nonprod_archive='export AWS_PROFILE=nonprod-archive && aws sso login'
alias aws_nonprod_audit='export AWS_PROFILE=nonprod-audit && aws sso login'
alias aws_nonprod_root='export AWS_PROFILE=nonprod-root && aws sso login'
alias aws_prod_archive='export AWS_PROFILE=prod-archive && aws sso login'
alias aws_prod_audit='export AWS_PROFILE=prod-audit && aws sso login'
alias aws_prod_root='export AWS_PROFILE=prod-root && aws sso login'
alias aws_digicert_epcs='export AWS_PROFILE=digicert_epcs && aws sso login'
alias aws_nonprod_eam_ami='export AWS_PROFILE=nonprod-eam-ami && aws sso login'
...
alias aws_bi_test='export AWS_PROFILE=bi-test-538263340534 && aws sso login'
