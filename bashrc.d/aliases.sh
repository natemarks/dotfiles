...
alias aws_beta_claude_power='export AWS_PROFILE=beta-claude-power && aws sso login --sso-session imprivata'
...
alias aws_bi_prod='export AWS_PROFILE=bi-prod-882805240806 && aws sso login --sso-session imprivata'
