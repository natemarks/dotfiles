...
alias aws_nonprod_archive='export AWS_PROFILE=nonprod-archive && aws sso login --sso-session imprivata'
alias aws_nonprod_audit='export AWS_PROFILE=nonprod-audit && aws sso login --sso-session imprivata'
alias aws_nonprod_root='export AWS_PROFILE=nonprod-root && aws sso login --sso-session imprivata'
...
alias aws_nonprod_eam_ami='export AWS_PROFILE=nonprod-eam-ami && aws sso login --sso-session imprivata'
